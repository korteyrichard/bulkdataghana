...
export default function DashboardLayout({ user, header, children }: DashboardLayoutProps) {
    ...
    const navigation: NavigationItem[] = [
        ...
        { name: 'My Shop', href: route('shop.dashboard'), icon: 'Store', current: route().current('shop.*') },
        ...
        { name: 'Result Checker', href: route('dashboard.result-checker'), icon: 'ClipboardList', current: route().current('dashboard.result-checker') },
    ...
    const SidebarContent = ({ isMobile = false }: { isMobile?: boolean }) => (
        <div className="flex flex-col flex-grow bg-gradient-to-br from-cyan-600 via-teal-700 to-blue-800 pt-5 pb-4 overflow-y-auto h-full">
            ...
            <nav className="mt-5 flex-1 flex flex-col min-h-screen">
                ...
                <a href='https://wa.me/qr/HEAEYXEJY7T6C1' className="w-[200px] ml-3 text-left mt-10 px-2 py-2 text-sm font-bold rounded-md text-white bg-green-600 hover:bg-green-700 transition-colors">
                    Contact Support
                </a>
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="lg:pl-64 flex flex-col flex-1">
                {/* Navbar */}
                <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-gradient-to-r from-cyan-600 via-teal-700 to-blue-800 shadow-sm lg:shadow-none">
